...
class Client extends openapi_client_1.default {
    ...
    async wikiWordsDetailWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("WikiWordsDetail", "wiki_1.0", "HTTP", "GET", "AK", `/v1.0/wiki/words/details`, "json", req, runtime), new WikiWordsDetailResponse({}));
    }
    ...
    async wikiWordsParseWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("WikiWordsParse", "wiki_1.0", "HTTP", "POST", "AK", `/v1.0/wiki/words/parse`, "json", req, runtime), new WikiWordsParseResponse({}));
    }
}
