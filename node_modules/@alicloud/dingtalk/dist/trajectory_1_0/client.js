...
class Client extends openapi_client_1.default {
    ...
    async queryAppActiveUsersWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("QueryAppActiveUsers", "trajectory_1.0", "HTTP", "GET", "AK", `/v1.0/trajectory/activeUsers`, "json", req, runtime), new QueryAppActiveUsersResponse({}));
    }
    ...
    async queryCollectingTraceTaskWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("QueryCollectingTraceTask", "trajectory_1.0", "HTTP", "POST", "AK", `/v1.0/trajectory/currentTasks/queryByUserIds`, "json", req, runtime), new QueryCollectingTraceTaskResponse({}));
    }
    ...
    async queryPageTraceDataWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("QueryPageTraceData", "trajectory_1.0", "HTTP", "GET", "AK", `/v1.0/trajectory/data`, "json", req, runtime), new QueryPageTraceDataResponse({}));
    }
}
