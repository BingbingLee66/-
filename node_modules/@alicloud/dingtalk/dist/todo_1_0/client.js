...
class Client extends openapi_client_1.default {
    ...
    async countTodoTasksWithOptions(unionId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("CountTodoTasks", "todo_1.0", "HTTP", "POST", "AK", `/v1.0/todo/users/${unionId}/tasks/count`, "json", req, runtime), new CountTodoTasksResponse({}));
    }
    ...
    async createTodoTaskWithOptions(unionId, request, headers, runtime) {
        ...
        if (!tea_util_1.default.isUnset($tea.toMap(request.detailUrl))) {
        ...
        if (!tea_util_1.default.isUnset($tea.toMap(request.notifyConfigs))) {
        ...
        return $tea.cast(await this.doROARequest("CreateTodoTask", "todo_1.0", "HTTP", "POST", "AK", `/v1.0/todo/users/${unionId}/tasks`, "json", req, runtime), new CreateTodoTaskResponse({}));
    }
    ...
    async createTodoTypeConfigWithOptions(unionId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("CreateTodoTypeConfig", "todo_1.0", "HTTP", "POST", "AK", `/v1.0/todo/users/${unionId}/configs/types`, "json", req, runtime), new CreateTodoTypeConfigResponse({}));
    }
    ...
    async deleteTodoTaskWithOptions(unionId, taskId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("DeleteTodoTask", "todo_1.0", "HTTP", "DELETE", "AK", `/v1.0/todo/users/${unionId}/tasks/${taskId}`, "json", req, runtime), new DeleteTodoTaskResponse({}));
    }
    ...
    async getTodoTaskWithOptions(unionId, taskId, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetTodoTask", "todo_1.0", "HTTP", "GET", "AK", `/v1.0/todo/users/${unionId}/tasks/${taskId}`, "json", req, runtime), new GetTodoTaskResponse({}));
    }
    ...
    async getTodoTaskBySourceIdWithOptions(unionId, sourceId, headers, runtime) {
        unionId = openapi_util_1.default.getEncodeParam(unionId);
        sourceId = openapi_util_1.default.getEncodeParam(sourceId);
        let realHeaders = {};
        if (!tea_util_1.default.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        }
        ...
        return $tea.cast(await this.doROARequest("GetTodoTaskBySourceId", "todo_1.0", "HTTP", "GET", "AK", `/v1.0/todo/users/${unionId}/tasks/sources/${sourceId}`, "json", req, runtime), new GetTodoTaskBySourceIdResponse({}));
    }
    ...
    async getTodoTaskDetailWithOptions(taskId, unionId, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetTodoTaskDetail", "todo_1.0", "HTTP", "GET", "AK", `/v1.0/todo/exclusive/users/${unionId}/tasks/${taskId}`, "json", req, runtime), new GetTodoTaskDetailResponse({}));
    }
    ...
    async getTodoTypeConfigWithOptions(unionId, cardTypeId, headers, runtime) {
        unionId = openapi_util_1.default.getEncodeParam(unionId);
        cardTypeId = openapi_util_1.default.getEncodeParam(cardTypeId);
        let realHeaders = {};
        if (!tea_util_1.default.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        }
        ...
        return $tea.cast(await this.doROARequest("GetTodoTypeConfig", "todo_1.0", "HTTP", "GET", "AK", `/v1.0/todo/users/${unionId}/configs/types/${cardTypeId}`, "json", req, runtime), new GetTodoTypeConfigResponse({}));
    }
    ...
    async queryOrgTodoByUserWithOptions(unionId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("QueryOrgTodoByUser", "todo_1.0", "HTTP", "POST", "AK", `/v1.0/todo/users/${unionId}/organizations/tasks/query`, "json", req, runtime), new QueryOrgTodoByUserResponse({}));
    }
    ...
    async queryOrgTodoTasksWithOptions(unionId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("QueryOrgTodoTasks", "todo_1.0", "HTTP", "POST", "AK", `/v1.0/todo/users/${unionId}/org/tasks/query`, "json", req, runtime), new QueryOrgTodoTasksResponse({}));
    }
    ...
    async queryTodoTasksWithOptions(unionId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("QueryTodoTasks", "todo_1.0", "HTTP", "POST", "AK", `/v1.0/todo/users/${unionId}/tasks/list`, "json", req, runtime), new QueryTodoTasksResponse({}));
    }
    ...
    async updateTodoTaskWithOptions(unionId, taskId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("UpdateTodoTask", "todo_1.0", "HTTP", "PUT", "AK", `/v1.0/todo/users/${unionId}/tasks/${taskId}`, "json", req, runtime), new UpdateTodoTaskResponse({}));
    }
    ...
    async updateTodoTaskExecutorStatusWithOptions(unionId, taskId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("UpdateTodoTaskExecutorStatus", "todo_1.0", "HTTP", "PUT", "AK", `/v1.0/todo/users/${unionId}/tasks/${taskId}/executorStatus`, "json", req, runtime), new UpdateTodoTaskExecutorStatusResponse({}));
    }
    ...
    async updateTodoTypeConfigWithOptions(unionId, cardTypeId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("UpdateTodoTypeConfig", "todo_1.0", "HTTP", "PUT", "AK", `/v1.0/todo/users/${unionId}/configs/types/${cardTypeId}`, "json", req, runtime), new UpdateTodoTypeConfigResponse({}));
    }
}
