...
class Client extends openapi_client_1.default {
    ...
    async createFeedWithOptions(request, headers, runtime) {
        ...
        let body = {};
        if (!tea_util_1.default.isUnset($tea.toMap(request.courseInfo))) {
            body["courseInfo"] = request.courseInfo;
        }
        if (!tea_util_1.default.isUnset(request.createUserId)) {
            body["createUserId"] = request.createUserId;
        }
        if (!tea_util_1.default.isUnset($tea.toMap(request.feedInfo))) {
        ...
        return $tea.cast(await this.doROARequest("CreateFeed", "content_1.0", "HTTP", "POST", "AK", `/v1.0/content/feeds`, "json", req, runtime), new CreateFeedResponse({}));
    }
    ...
    async getFeedWithOptions(feedId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetFeed", "content_1.0", "HTTP", "GET", "AK", `/v1.0/content/feeds/${feedId}`, "json", req, runtime), new GetFeedResponse({}));
    }
    ...
    async getMediaCerficateWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetMediaCerficate", "content_1.0", "HTTP", "GET", "AK", `/v1.0/content/media/cerficates`, "json", req, runtime), new GetMediaCerficateResponse({}));
    }
    ...
    async listItemUserDataWithOptions(itemId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("ListItemUserData", "content_1.0", "HTTP", "POST", "AK", `/v1.0/content/feeds/items/${itemId}/userStatistics/query`, "json", req, runtime), new ListItemUserDataResponse({}));
    }
    ...
    async pageFeedWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("PageFeed", "content_1.0", "HTTP", "POST", "AK", `/v1.0/content/feeds/query`, "json", req, runtime), new PageFeedResponse({}));
    }
}
