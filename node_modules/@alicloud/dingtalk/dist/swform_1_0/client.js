...
class Client extends openapi_client_1.default {
    ...
    async getFormInstanceWithOptions(formInstanceId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetFormInstance", "swform_1.0", "HTTP", "GET", "AK", `/v1.0/swform/instances/${formInstanceId}`, "json", req, runtime), new GetFormInstanceResponse({}));
    }
    ...
    async listFormInstancesWithOptions(formCode, request, headers, runtime) {
        tea_util_1.default.validateModel(request);
        formCode = openapi_util_1.default.getEncodeParam(formCode);
        let query = {};
        ...
        return $tea.cast(await this.doROARequest("ListFormInstances", "swform_1.0", "HTTP", "GET", "AK", `/v1.0/swform/forms/${formCode}/instances`, "json", req, runtime), new ListFormInstancesResponse({}));
    }
    ...
    async listFormSchemasByCreatorWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("ListFormSchemasByCreator", "swform_1.0", "HTTP", "GET", "AK", `/v1.0/swform/users/forms`, "json", req, runtime), new ListFormSchemasByCreatorResponse({}));
    }
}
