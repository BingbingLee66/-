...
class Client extends openapi_client_1.default {
    ...
    async nlpWordDistinguishWithOptions(request, headers, runtime) {
        ...
        let body = {};
        if (!tea_util_1.default.isUnset($tea.toMap(request.attachExtractDecisionInfo))) {
        ...
        return $tea.cast(await this.doROARequest("NlpWordDistinguish", "algo_1.0", "HTTP", "POST", "AK", `/v1.0/algo/okrs/keywords/extract`, "json", req, runtime), new NlpWordDistinguishResponse({}));
    }
    ...
    async okrOpenRecommendWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("OkrOpenRecommend", "algo_1.0", "HTTP", "POST", "AK", `/v1.0/algo/okrs/recommend`, "json", req, runtime), new OkrOpenRecommendResponse({}));
    }
}
