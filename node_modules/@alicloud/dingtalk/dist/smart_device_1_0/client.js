...
class Client extends openapi_client_1.default {
    ...
    async addDeviceVideoConferenceMembersWithOptions(deviceId, conferenceId, request, headers, runtime) {
        ...
        deviceId = openapi_util_1.default.getEncodeParam(deviceId);
        ...
        return $tea.cast(await this.doROARequest("AddDeviceVideoConferenceMembers", "smartDevice_1.0", "HTTP", "POST", "AK", `/v1.0/smartDevice/devices/${deviceId}/videoConferences/${conferenceId}/members`, "none", req, runtime), new AddDeviceVideoConferenceMembersResponse({}));
    }
    ...
    async createDeviceVideoConferenceWithOptions(deviceId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("CreateDeviceVideoConference", "smartDevice_1.0", "HTTP", "POST", "AK", `/v1.0/smartDevice/devices/${deviceId}/videoConferences`, "json", req, runtime), new CreateDeviceVideoConferenceResponse({}));
    }
    ...
    async extractFacialFeatureWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("ExtractFacialFeature", "smartDevice_1.0", "HTTP", "POST", "AK", `/v1.0/smartDevice/faceRecognitions/features/extract`, "json", req, runtime), new ExtractFacialFeatureResponse({}));
    }
    ...
    async kickDeviceVideoConferenceMembersWithOptions(deviceId, conferenceId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("KickDeviceVideoConferenceMembers", "smartDevice_1.0", "HTTP", "POST", "AK", `/v1.0/smartDevice/devices/${deviceId}/videoConferences/${conferenceId}/members/batchDelete`, "none", req, runtime), new KickDeviceVideoConferenceMembersResponse({}));
    }
    ...
    async machineManagerUpdateWithOptions(request, headers, runtime) {
        tea_util_1.default.validateModel(request);
        let body = {};
        if (!tea_util_1.default.isUnset($tea.toMap(request.atmManagerRightMap))) {
        ...
        return $tea.cast(await this.doROARequest("MachineManagerUpdate", "smartDevice_1.0", "HTTP", "PUT", "AK", `/v1.0/smartDevice/atmachines/managers`, "none", req, runtime), new MachineManagerUpdateResponse({}));
    }
    ...
    async machineUsersUpdateWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("MachineUsersUpdate", "smartDevice_1.0", "HTTP", "PUT", "AK", `/v1.0/smartDevice/atmachines/users`, "none", req, runtime), new MachineUsersUpdateResponse({}));
    }
    ...
    async queryDeviceVideoConferenceBookWithOptions(deviceId, bookId, headers, runtime) {
        deviceId = openapi_util_1.default.getEncodeParam(deviceId);
        bookId = openapi_util_1.default.getEncodeParam(bookId);
        let realHeaders = {};
        if (!tea_util_1.default.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        }
        ...
        return $tea.cast(await this.doROARequest("QueryDeviceVideoConferenceBook", "smartDevice_1.0", "HTTP", "GET", "AK", `/v1.0/smartDevice/devices/${deviceId}/books/${bookId}`, "json", req, runtime), new QueryDeviceVideoConferenceBookResponse({}));
    }
}
