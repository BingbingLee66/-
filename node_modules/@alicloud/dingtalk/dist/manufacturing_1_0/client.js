...
class Client extends openapi_client_1.default {
    ...
    async industrializeManufactureJobBookWithOptions(userId, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("IndustrializeManufactureJobBook", "manufacturing_1.0", "HTTP", "POST", "AK", `/v1.0/manufacturing/users/${userId}/jobs`, "json", req, runtime), new IndustrializeManufactureJobBookResponse({}));
    }
    ...
    async industrializeManufactureQueryJobsWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("IndustrializeManufactureQueryJobs", "manufacturing_1.0", "HTTP", "POST", "AK", `/v1.0/manufacturing/users/jobs/query`, "json", req, runtime), new IndustrializeManufactureQueryJobsResponse({}));
    }
}
