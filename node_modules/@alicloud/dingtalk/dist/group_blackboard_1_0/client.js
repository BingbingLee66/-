...
class Client extends openapi_client_1.default {
    ...
    async createGroupBlackboardWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("CreateGroupBlackboard", "groupBlackboard_1.0", "HTTP", "POST", "AK", `/v1.0/groupBlackboard/blackboards`, "json", req, runtime), new CreateGroupBlackboardResponse({}));
    }
    ...
    async deleteGroupBlackboardWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("DeleteGroupBlackboard", "groupBlackboard_1.0", "HTTP", "POST", "AK", `/v1.0/groupBlackboard/blackboards/remove`, "json", req, runtime), new DeleteGroupBlackboardResponse({}));
    }
}
