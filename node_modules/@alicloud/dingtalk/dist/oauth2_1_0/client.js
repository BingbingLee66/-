...
class Client extends openapi_client_1.default {
    ...
    async createJsapiTicketWithOptions(headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("CreateJsapiTicket", "oauth2_1.0", "HTTP", "POST", "AK", `/v1.0/oauth2/jsapiTickets`, "json", req, runtime), new CreateJsapiTicketResponse({}));
    }
    ...
    async getAccessTokenWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetAccessToken", "oauth2_1.0", "HTTP", "POST", "AK", `/v1.0/oauth2/accessToken`, "json", req, runtime), new GetAccessTokenResponse({}));
    }
    ...
    async getAuthInfoWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetAuthInfo", "oauth2_1.0", "HTTP", "GET", "AK", `/v1.0/oauth2/apps/authInfo`, "json", req, runtime), new GetAuthInfoResponse({}));
    }
    ...
    async getCorpAccessTokenWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetCorpAccessToken", "oauth2_1.0", "HTTP", "POST", "AK", `/v1.0/oauth2/corpAccessToken`, "json", req, runtime), new GetCorpAccessTokenResponse({}));
    }
    ...
    async getPersonalAuthRuleWithOptions(headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetPersonalAuthRule", "oauth2_1.0", "HTTP", "GET", "AK", `/v1.0/oauth2/authRules/user`, "json", req, runtime), new GetPersonalAuthRuleResponse({}));
    }
    ...
    async getSsoAccessTokenWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetSsoAccessToken", "oauth2_1.0", "HTTP", "POST", "AK", `/v1.0/oauth2/ssoAccessToken`, "json", req, runtime), new GetSsoAccessTokenResponse({}));
    }
    ...
    async getSsoUserInfoWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetSsoUserInfo", "oauth2_1.0", "HTTP", "GET", "AK", `/v1.0/oauth2/ssoUserInfo`, "json", req, runtime), new GetSsoUserInfoResponse({}));
    }
    ...
    async getSuiteAccessTokenWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetSuiteAccessToken", "oauth2_1.0", "HTTP", "POST", "AK", `/v1.0/oauth2/suiteAccessToken`, "json", req, runtime), new GetSuiteAccessTokenResponse({}));
    }
    ...
    async getUserTokenWithOptions(request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("GetUserToken", "oauth2_1.0", "HTTP", "POST", "AK", `/v1.0/oauth2/userAccessToken`, "json", req, runtime), new GetUserTokenResponse({}));
    }
}
