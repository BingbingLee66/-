...
class Client extends openapi_client_1.default {
    ...
    async getTranscribeBriefWithOptions(taskUuid, headers, runtime) {
        taskUuid = openapi_util_1.default.getEncodeParam(taskUuid);
        let realHeaders = {};
        ...
        return $tea.cast(await this.doROARequest("GetTranscribeBrief", "transcribe_1.0", "HTTP", "GET", "AK", `/v1.0/transcribe/tasks/${taskUuid}/briefInfos`, "json", req, runtime), new GetTranscribeBriefResponse({}));
    }
    ...
    async removePermissionWithOptions(taskUuid, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("RemovePermission", "transcribe_1.0", "HTTP", "DELETE", "AK", `/v1.0/transcribe/tasks/${taskUuid}/permissions/remove`, "json", req, runtime), new RemovePermissionResponse({}));
    }
    ...
    async updatePermissionForUsersWithOptions(taskUuid, request, headers, runtime) {
        ...
        return $tea.cast(await this.doROARequest("UpdatePermissionForUsers", "transcribe_1.0", "HTTP", "PUT", "AK", `/v1.0/transcribe/tasks/${taskUuid}/permissions`, "json", req, runtime), new UpdatePermissionForUsersResponse({}));
    }
}
